...
let s:NRight = [s:nord5_gui, s:nord3_gui, s:nord5_term, s:nord3_term]
let s:NMiddle = [s:nord5_gui, s:nord1_gui, s:nord5_term, s:nord1_term]
...
let g:airline#themes#nord#palette.normal_modified = {
      \ 'airline_c': [ s:nord15_gui , '' , s:nord15_term , '' , ''      ] ,
      \ }

let s:IMain = [s:nord1_gui, s:nord14_gui, s:nord1_term, s:nord6_term]
let s:IRight = [s:nord1_gui, s:nord5_gui, s:nord1_term, s:nord5_term]
...
let g:airline#themes#nord#palette.insert_modified = {
      \ 'airline_c': [ s:nord1_gui , s:nord13_gui , s:nord1_term , s:nord13_term , ''      ] ,
      \ }

let s:RMain = [s:nord1_gui, s:nord11_gui, s:nord1_term, s:nord11_term]
let s:RRight = [s:nord1_gui, s:nord13_gui, s:nord1_term, s:nord13_term]
...
let g:airline#themes#nord#palette.replace_modified = {
      \ 'airline_c': [ s:nord1_gui , s:nord5_gui , s:nord1_term , s:nord5_term , ''      ] ,
      \ }

let s:VMain = [s:nord1_gui, s:nord15_gui, s:nord1_term, s:nord15_term]
let s:VRight = [s:nord1_gui, s:nord8_gui, s:nord1_term, s:nord8_term]
...
let g:airline#themes#nord#palette.visual_modified = g:airline#themes#nord#palette.replace_modified
...
let g:airline#themes#nord#palette.inactive_modified = {
      \ 'airline_c': [ s:nord1_gui , s:nord15_gui , s:nord1_term , s:nord15_term , ''      ] ,
      \ }
